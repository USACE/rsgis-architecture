...
4. Create a lambda function called **rsgis-lambda-zip-deployer**
   ...
   The code for the lambda function is written in javascript and is tracked in source control at https://github.com/USACE/rsgis_lambda_zip_deployer

   The function code is short enough that it it's copied below to give an idea of how it works:
   ...
   3. Publish Lambda Layer Versions

      ```
      Actions:
         lambda:PublishLayerVersion
      Resources:
         rsgis-cumulus-geolambda-base
         rsgis-cumulus-geolambda-python
         <Lambda Layer 1>
         <Lambda Layer 2>
         <Lambda Layer ... >
   ...
   4. AWSLambdaBasicExecutionRole (Basic role to allow creating/writing cloudwatch logs)
